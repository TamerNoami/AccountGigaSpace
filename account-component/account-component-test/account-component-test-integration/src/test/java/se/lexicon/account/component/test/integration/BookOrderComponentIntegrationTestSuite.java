...
import se.lexicon.account.component.service.BookOrderComponentServiceProvider;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        BookOrderComponentServiceIntegrationTest.class,
        BookOrderComponentClientIntegrationTest.class
})
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class BookOrderComponentIntegrationTestSuite {
    ...
    public static ServiceBindingRule getServiceBindingRule() {
        if (SERVICE_BINDING_RULE == null) {
            ...
            SERVICE_BINDING_RULE.addServiceProvider(BookOrderComponentServiceProvider.class);
        }
